...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      competition_status:
        "draft" | "scheduled" | "lobby_open" | "running" | "completed" | "cancelled";
      ...
      host_request_purpose: "university" | "company" | "association" | "community" | "other";
...
export const Constants = {
  public: {
    Enums: {
      app_role: ["admin", "host"],
      competition_mode: ["hosted", "arena", "scheduled"],
      competition_status: ["draft", "scheduled", "lobby_open", "running", "completed", "cancelled"],
      competition_visibility: ["private", "unlisted", "public"],
      host_auth_status: ["active", "expired", "revoked", "consumed"],
      host_auth_type: ["single", "bundle", "time"],
      host_request_purpose: ["university", "company", "association", "community", "other"],
